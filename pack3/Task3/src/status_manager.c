...
void print_status(Status error){
    ...
    case NON_NATURAL_NUMBER:
        printf("ERROR: program expected natural numbers as input! ∪･ｪ･∪\n");
        break;
    case NUMBER_IS_ZERO:
    ...
    case NO_SOLUTION:
        ...
        break;
    case CANT_OPEN_FILE:
        printf("Error: can`t open file!(μ_μ)\n");
        break;
    case TOO_LONG_WORD:
        printf("Error: too long word to process!\n");
        break;
    case INVALID_CHARACTER:
        printf("Error: input have invalid characters ┐( ˘_˘ )┌\n");
        break;
    case END_OF_INPUT:
    ...
    case EMPTY_STRING:
        ...
        break;
    case POP_EMPTY_VECTOR:
        printf("Error: pop in empty vector!\n");
        break;
    case INDEX_OUT_OF_THE_RANGE:
        printf("Error: index out of the range!\n");
        break;
    case INVALID_DATE:
        printf("Error: invalid date format!(x.x)\n");
        break;
    case NULL_VALUE:
        printf("Error: unexpected null value! (⌐■_■)\n");
        break;
    case THIRD_GENDER:
        printf("Error: third gender!(⊙_⊙)\n");
        break;
    case NOT_UNIQUE_ID:
        printf("Error: liver with such id already exist!!! ╭( ͡°͡° ͜ʖ ͡°͡°)╮\n");
        break;
    case UNKNOWN_LIVER:
        printf("Error: no such liver!!!! w(°ｏ°)w\n");
        break;
    default:
